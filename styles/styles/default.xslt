...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:template match="PackageSummary">
        <ul id="summary_stats">
            <li>
                <strong>
                    <xsl:value-of select="MetricResult[@name = 'ABC']/@average"/>
                </strong>
                <span>ABC</span>
            </li>
            <li>
                <strong>
                    <xsl:value-of select="MetricResult[@name = 'CyclomaticComplexity']/@average"/>
                </strong>
                <span>cyclomatic complexity</span>
            </li>
            <li>
                <strong>
                    <xsl:value-of select="MetricResult[@name = 'MethodLineCount']/@average"/>
                </strong>
                <span>method lines</span>
            </li>
            <li>
                <strong>
                    <xsl:value-of select="MetricResult[@name = 'ClassLineCount']/@average"/>
                </strong>
    ...
    <xsl:template match="GMetrics" mode="summary">
        <h2>Files</h2>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tbody>
                    <tr>
                        ...
                        <td>
                            <a href="#m-{$cyclomaticComplexity/@name}">
                                <h3>Complexity</h3>
                            </a>
                            <p>
                                <strong>
